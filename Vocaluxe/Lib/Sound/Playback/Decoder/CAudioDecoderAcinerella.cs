...
{
    /// <summary>
    ///     Audio decoding through the Acinerella C wrapper. Kept while the direct ffmpeg decoder
    ///     (<see cref="CAudioDecoderFFmpeg" />) is being proven; the name used to say FFmpeg, which
    ///     it only ever was second-hand.
    /// </summary>
    class CAudioDecoderAcinerella : IAudioDecoder, IDisposable
    {
